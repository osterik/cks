...
@test "1. PV pv-analytics (100Mi, RWO, hostPath /pv/analytics)" {
  ...
  cap=$(kubectl get pv pv-analytics $CTX -o jsonpath='{.spec.capacity.storage}' 2>/dev/null)
  am=$(kubectl get pv pv-analytics $CTX -o jsonpath='{.spec.accessModes[0]}' 2>/dev/null)
  hp=$(kubectl get pv pv-analytics $CTX -o jsonpath='{.spec.hostPath.path}' 2>/dev/null)
