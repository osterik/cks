...
გარემოს მომზადებისას worker-ზე იქმნება Pod სახელად `reserve`, რომლის რესურსების მოთხოვნებია
`1500m` CPU და `1200Mi` მეხსიერება. ამის გამო worker ნაკლებად სასურველი ხდება ნაგულისხმევი
დამგეგმავისთვის, როდესაც Pod-ს node-ზე განთავსების შეზღუდვა არ აქვს, ამიტომ მე-3 დავალებაში
აუცილებელია `nodeSelector`-ის ცხადად მითითება. Pod `reserve` და მისი რესურსების მოთხოვნები
ლაბორატორიის ინფრასტრუქტურის ნაწილია და არ უნდა შეიცვალოს.
