...
| Acceptance criteria | - PriorityClass name `monitoring` with value `1000000000`<br>- DaemonSet `monitoring-system` in `monitoring` NS has PriorityClass `monitoring`<br>- all pods in `monitoring` NS havestatus `Running` |
